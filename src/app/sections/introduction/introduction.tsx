...
export const IntroductionSection = () => {
  return (
    <div className="h-[90vh] md:h-[900px] bg-tertiary bg-img bg-[url('/assets/avatar.png')] bg-no-repeat bg-center bg-cover md:bg-contain overflow-x-hidden relative">
      <Header />
      ...
      <div className="h-full w-full md:w-[50.5%] bg-primary-light opacity-95 md:opacity-80 md:animate-bounce-finite md:translate-x-[100%] absolute top-0">
        <div className="h-full flex flex-col items-center justify-center ">
          <div>
            ...
            <p className="text-text-dark font-thin uppercase text-4xl leading-[2rem] md:text-6xl md:leading-[3.5rem] xl:text-8xl xl:leading-[5rem]">
